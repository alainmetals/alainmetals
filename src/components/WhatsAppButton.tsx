...
export function WhatsAppButton() {
  ...
  const whatsappUrl = `https://wa.me/${company.whatsapp}?text=${encodeURIComponent("Hello AL AIN METALS, I would like to discuss my requirements.")}`
    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-40 w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300"
